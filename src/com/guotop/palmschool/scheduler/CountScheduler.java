						...
						if(!CollectionUtils.isEmpty(orderMessageList)){
							for(OrderMessage orderMessage : orderMessageList){
								try{
									...
									//获取服务费对应的学生数目
									Integer messageCount = orderMessageService.getOrderMessageCountByMessageId(messageId);
									//未购买服务费的人员=服务费设置的对应人员-已经支付的人员-免支付人员
									Integer unPayCount = messageCount-alreadyPayCount-freePayCount;
