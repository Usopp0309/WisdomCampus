...
CREATE TABLE `palm_asset` (
  ...
  `updateTime` varchar(32) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='资产表';
...
CREATE TABLE `palm_asset_import` (
  ...
  `createTime` varchar(32) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='资产导入信息表';
...
CREATE TABLE `palm_camera_clazz` (
  ...
  `createTime` varchar(32) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='摄像头和班级的关系';
...
CREATE TABLE `palm_camera_user` (
  ...
  `createTime` varchar(32) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='摄像头和人员的关系';
...
INSERT INTO `palm_menu` VALUES ('inout', '进园记录', '0', 'safeSchool', 'inout/toInoutList.do', 'fa-file-text-o', '1', 'inoutManager', '1');
...
INSERT INTO `palm_menu` VALUES ('yitijiHeadImg', '显示头像录入', '1', 'safeSchool', 'saveHeadImg/toUploadHeadImg.do', 'icon-user', '1', 'yitijiHeadImg', '4');
INSERT INTO `palm_menu` VALUES ('accessInoutAbnormal', '无障碍异常记录', '1', 'safeSchool', 'accessInout/toAccessInoutAbnormal.do', 'fa-envelope-o', '1', 'accessInoutAbnormal', '5');
...
INSERT INTO `palm_menu` VALUES ('mySms', '我的信息', '0', 'informationPlatform', 'sms/toMySms.do', 'fa-user', '1', 'myMessageManager', '4');
INSERT INTO `palm_menu` VALUES ('smsShow', '发送短信查看', '0', 'informationPlatform', 'sms/toSmsList.do', 'fa-envelope-square', '1', 'sendMessageHistoryManager', '5');
INSERT INTO `palm_menu` VALUES ('onlineTeacherMessage', '教师在线留言', '0', 'informationPlatform', 'online-message/toTeacherSms.do', 'fa-comment', '1', 'teacherOnlineMessageManager', '6');
INSERT INTO `palm_menu` VALUES ('onlineStudentMessage', '学生在线留言', '0', 'informationPlatform', 'online-message/toStudentSms.do', 'fa-comment-o', '1', 'studentOnlineMessageManager', '7');
INSERT INTO `palm_menu` VALUES ('onlineMessageShow', '发送留言查看', '0', 'informationPlatform', 'online-message/toSmsList.do', 'fa-commenting-o', '1', 'sendOnlineMessageHistoryManager', '8');
...
INSERT INTO `palm_menu` VALUES ('attendance', '教师考勤', '0', null, null, 'fa-clipboard', '1', null, '5');
...
INSERT INTO `palm_menu` VALUES ('attendanceReport', '考勤统计', '0', 'attendance', 'check/toCheckReport.do', 'fa-file-text', '1', 'attendanceStatisticsManager', '2');
INSERT INTO `palm_menu` VALUES ('attendanceFill', '考勤补录', '0', 'attendance', 'check/toAttendanceRecord.do', 'fa-paint-brush', '1', 'attendanceRecordManager', '3');
...
INSERT INTO `palm_menu` VALUES ('morningCheckSys', '晨检系统', '1', null, null, 'icon-medkit', '1', '', '7');
INSERT INTO `palm_menu` VALUES ('morningCheck', '今日晨检', '1', 'morningCheckSys', 'morningCheck/toMorningCheckList.do', 'icon-medkit', '1', 'morningCheck', '1');
INSERT INTO `palm_menu` VALUES ('redFlower', '小小红花榜', '1', null, null, 'icon-comment-alt', '1', null, '8');
INSERT INTO `palm_menu` VALUES ('evaluateList', '小小红花榜', '1', 'redFlower', 'evaluateKindergarten/toEvaluate.do', 'icon-comment-alt', '1', 'evaluateKindergartenListManager', '1');
INSERT INTO `palm_menu` VALUES ('recipeManager', '营养食谱', '1', null, null, 'm_icon-Cookbooks', '1', null, '9');
INSERT INTO `palm_menu` VALUES ('recipeExhibition', '营养食谱', '1', 'recipeManager', 'recipe/toRecipeDisplay.do', 'm_icon-Cookbooks', '1', null, '1');
INSERT INTO `palm_menu` VALUES ('clazzPhotoAlbumManager', '校园相册', '0', null, null, 'm_icon-album', '1', null, '10');
INSERT INTO `palm_menu` VALUES ('clazzPhotoAlbum', '班级相册', '0', 'clazzPhotoAlbumManager', 'clazzAlbum/toClazzPhotoAlbumList.do', 'm_icon-album', '1', null, '1');
INSERT INTO `palm_menu` VALUES ('selfPhotoAlbum', '个人相册', '0', 'clazzPhotoAlbumManager', 'personAlbum/toPersonAlbum.do', 'icon-leaf', '1', NULL, '2');
INSERT INTO `palm_menu` VALUES ('evaluationManager', '教学评价', '1', null, null, 'fa-star-half-full', '1', null, '11');
INSERT INTO `palm_menu` VALUES ('setEvaluationTimeManager', '时间设定', '1', 'evaluationManager', 'evaluation/toEvaluationTime.do', 'fa-clock-o', '1', 'setEvaluationTimeManager', '1');
INSERT INTO `palm_menu` VALUES ('setEvaluationTemplateManager', '模板设定', '1', 'evaluationManager', 'evaluation/toEvaluationTemplate.do', 'fa-tasks', '1', 'setEvaluationTemplateManager', '2');
INSERT INTO `palm_menu` VALUES ('evaluationListManager', '模板列表', '1', 'evaluationManager', 'evaluation/toEvaluationList.do', 'fa-list-ul', '1', 'evaluationListManager', '3');
INSERT INTO `palm_menu` VALUES ('teacherEvaluationViewManager', '教师评价查看', '1', 'evaluationManager', 'evaluation/toTeacherEvaluationView.do', 'fa-file-text-o', '1', 'teacherEvaluationViewManager', '4');
INSERT INTO `palm_menu` VALUES ('studentEvaluationViewManager', '学生评价查看', '1', 'evaluationManager', 'evaluation/toStudentEvaluationView.do', 'fa-file', '1', 'studentEvaluationViewManager', '5');
INSERT INTO `palm_menu` VALUES ('teacherEvaluationDetailManager', '已评或未评教师', '1', 'evaluationManager', 'evaluation/toTeacherEvaluationDetail.do', 'fa-user', '1', 'teacherEvaluationDetailManager', '6');
INSERT INTO `palm_menu` VALUES ('studentEvaluationDetailManager', '已评或未评学生', '1', 'evaluationManager', 'evaluation/toStudentEvaluationDetail.do', 'fa-male', '1', 'studentEvaluationDetailManager', '7');
INSERT INTO `palm_menu` VALUES ('dailyActivities', '每日活动', '1', NULL, NULL, 'icon-flag', '1', NULL, '12');
INSERT INTO `palm_menu` VALUES ('todayActivity', '每日活动', '1', 'dailyActivities', 'todayActivity/toTodayActivity.do', 'icon-flag', '1', NULL, '1');
INSERT INTO `palm_menu` VALUES ('growthArchives', '快乐成长档案', '1', null, null, 'fa-clipboard', '1', null, '13');
INSERT INTO `palm_menu` VALUES ('growth', '成长档案', '1', 'growthArchives', 'growth/toArchiveList.do', 'icon-signal', '1', 'growthManager', '1');
INSERT INTO `palm_menu` VALUES ('campusNewsManager','校园新闻','0',NULL,NULL,'fa-list-alt','1','campusNewsManager','14');
INSERT INTO `palm_menu` VALUES ('schoolNewsRelease','校园新闻发布','0','campusNewsManager','schoolNewsRelease/toSchoolNewsRelease.do','fa-file-word-o','1','schoolNewsReleaseManager','1');
INSERT INTO `palm_menu` VALUES ('schoolNewsLook','校园新闻查看','0','campusNewsManager','schoolNewsLook/toSchoolNewsLook.do','fa-eye','1','schoolNewsLookManager','2');
INSERT INTO `palm_menu` VALUES ('siguUpManager','信息发布管理','0',NULL,NULL,'fa-file-text','1','signUpManager','15');
INSERT INTO `palm_menu` VALUES ('signUpInfoManager','招生信息采集','0','siguUpManager','applyInfo/toApplyInfoList.do','fa-file-text','1','signUpInfoManager','1');
...
INSERT INTO `palm_menu` VALUES ('cameraManager','视频管理','1','liveCameraManager','camera/toCameraManager.do','fa-object-group','1','cameraManager','2');
...
INSERT INTO `palm_permission` VALUES ('yitijiHeadImg', '一体机头像设置', '0', null);
INSERT INTO `palm_permission` VALUES ('morningCheck', '晨检', '0', null);
...
INSERT INTO `palm_permission` VALUES ('evaluateKindergartenListManager','幼儿园老师评价','0',NULL);
INSERT INTO `palm_permission` VALUES ('addEvaluateKindergarten','添加幼儿园教师评价按钮','1','evaluateKindergartenListManager');
INSERT INTO `palm_permission` VALUES ('growthManager','成长档案','0',null);
INSERT INTO `palm_permission` VALUES ('menuConfig','菜单管理','0',null);
...
INSERT INTO `palm_permission` VALUES ('todayActivityManager', '今日活动', '0', NULL);
INSERT INTO `palm_permission` VALUES ('todayActivityEdit', '今日活动编辑', '1', 'todayActivityManager');
...
INSERT INTO `palm_permission` VALUES ('messageManage', '智慧校园 服务费', '0', NULL);
...
INSERT INTO `palm_role_permission` VALUES ('150', 'parent', 'yitijiHeadImg');
INSERT INTO `palm_role_permission` VALUES ('151', 'parent', 'morningCheck');
INSERT INTO `palm_role_permission` VALUES ('152', 'classLeader', 'morningCheck');
INSERT INTO `palm_role_permission` VALUES ('153', 'classLeader', 'growthManager');
INSERT INTO `palm_role_permission` VALUES ('154', 'parent', 'growthManager');
INSERT INTO `palm_role_permission` VALUES ('155', 'classLeader','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('156', 'departManager','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('157', 'employee','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('158', 'other','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('159', 'parent','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('160', 'student','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('161', 'teacher','recipeDisplay');
INSERT INTO `palm_role_permission` VALUES ('162', 'student', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('163', 'classLeader', 'schoolNewsReleaseManager');
INSERT INTO `palm_role_permission` VALUES ('164', 'classLeader', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('165', 'parent', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('166', 'teacher', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('167', 'departManager', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('168', 'employee', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('169', 'other', 'schoolNewsLookManager');
INSERT INTO `palm_role_permission` VALUES ('170', 'classLeader', 'todayActivityEdit');
INSERT INTO `palm_role_permission` VALUES ('171', 'classLeader', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('172', 'departManager', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('173', 'employee', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('174', 'other', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('175', 'parent', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('176', 'student', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('177', 'teacher', 'todayActivityManager');
INSERT INTO `palm_role_permission` VALUES ('178', 'parent', 'cameraManager');
INSERT INTO `palm_role_permission` VALUES ('179', 'student', 'cameraManager');
INSERT INTO `palm_role_permission` VALUES ('180', 'teacher', 'cameraManager');
INSERT INTO `palm_role_permission` VALUES ('181', 'departManager', 'cameraManager');
INSERT INTO `palm_role_permission` VALUES ('182', 'classLeader', 'cameraManager');
INSERT INTO `palm_role_permission` VALUES ('183', 'classLeader', 'studentParentModify');
INSERT INTO `palm_role_permission` VALUES ('184', 'classLeader', 'replaceRechargeManager');
INSERT INTO `palm_role_permission` VALUES ('185', 'parent', 'replaceRechargeManager');
INSERT INTO `palm_role_permission` VALUES ('186', 'classLeader', 'messageManage');
INSERT INTO `palm_role_permission` VALUES ('187', 'parent', 'messageManage');
INSERT INTO `palm_role_permission` VALUES ('188', 'parent', 'orderMessageManager');
INSERT INTO `palm_role_permission` VALUES ('189','teacher', 'securityDanger');
INSERT INTO `palm_role_permission` VALUES ('192','classLeader', 'securityDanger');
INSERT INTO `palm_role_permission` VALUES ('193','departManager', 'securityDanger');
INSERT INTO `palm_role_permission` VALUES ('194','employee', 'securityDanger');
