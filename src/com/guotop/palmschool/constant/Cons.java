...
public class Cons
{
	...
	// 百度推送消息设置
	public static final String PUSH_APIKEY = "fyWBYCBRMLGBThpbXiSXQadD";
	public static final String PUSH_SECRETKEY = "2G2uXWBtKu4X2PQrQ5Najw1IwPX1DGGS";
	public static final String PUSH_IOSAPIKEY = "249No3utppAyO89q2tC3a20L";
	public static final String PUSH_IOSSECRETKEY = "Gf2ng4EFOMUyAESr0fHsUg5OZYcyCFcB";
	...
	public static enum PUSHTYPE
	{
		TEACHERPUSH
		{
			public String getName(){return "教师通知";}
			public int getType(){return 6;}
			public int getContentType(){return 1;}
		},
		STUDENTPUSH
		{
			public String getName(){return "学生通知";}
			public int getType(){return 6;}
			public int getContentType(){return 2;}
		},
		SCOREPUSH
		{
			public String getName(){return "成绩通知";}
			public int getType(){return 7;}
			public int getContentType(){return 1;}
		},
		MEETINGPUSH
		{
			public String getName(){return "会议通知";}
			public int getType(){return 3;}
			public int getContentType(){return 1;}
		},
		SCHOOLBUSINPUSH
		{
			public String getName(){return "校车上车通知";}
			public int getType(){return 5;}
			public int getContentType(){return 1;}
		},
		SCHOOLBUSOUTPUSH
		{
			public String getName(){return "校车下车通知";}
			public int getType(){return 5;}
			public int getContentType(){return 2;}
		},
		SYSANNOUNCEMENTPUSH
		{
			public String getName(){return "系统公告通知";}
			public int getType(){return 1;}
			public int getContentType(){return 4;}
		},
		SCHOOLANNOUNCEMENTPUSH
		{
			public String getName(){return "学校公告通知";}
			public int getType(){return 1;}
			public int getContentType(){return 1;}
		},
		DEPARTANNOUNCEMENTPUSH
		{
			public String getName(){return "部门公告通知";}
			public int getType(){return 1;}
			public int getContentType(){return 2;}
		},
		CLAZZANNOUNCEMENTPUSH
		{
			public String getName(){return "班级公告通知";}
			public int getType(){return 1;}
			public int getContentType(){return 3;}
		},
		LEAVEAUDITPUSH
		{
			public String getName(){return "请假审批通知";}
			public int getType(){return 2;}
			public int getContentType(){return 1;}
		},
		LEAVEPASSPUSH
		{
			public String getName(){return "请假审批通过通知";}
			public int getType(){return 2;}
			public int getContentType(){return 2;}
		},
		LEAVENOTPASSPUSH
		{
			public String getName(){return "请假审批拒绝通知";}
			public int getType(){return 2;}
			public int getContentType(){return 3;}
		},
		INSCHOOLPUSH
		{
			public String getName(){return "进学校通知";}
			public int getType(){return 8;}
			public int getContentType(){return 1;}
		},
		OUTSCHOOLPUSH
		{
			public String getName(){return "出学校通知";}
			public int getType(){return 8;}
			public int getContentType(){return 2;}
		},
		INDORMITORYPUSH
		{
			public String getName(){return "进宿舍通知";}
			public int getType(){return 4;}
			public int getContentType(){return 1;}
		},
		OUTDORMITORYPUSH
		{
			public String getName(){return "出宿舍通知";}
			public int getType(){return 4;}
			public int getContentType(){return 2;}
		},
		YKTBALANCEPUSH
		{
			public String getName(){return "一卡通通知余额不足";}
			public int getType(){return 9;}
			public int getContentType(){return 1;}
		},
		YKTCONSUMPTIONPUSH
		{
			public String getName(){return "一卡通通知消费";}
			public int getType(){return 9;}
			public int getContentType(){return 2;}
		},
		YKTDEPOSITPUSH
		{
			public String getName(){return "一卡通通知充值(存款)";}
			public int getType(){return 9;}
			public int getContentType(){return 3;}
		},
		YKTOPENACCOUNTPUSH
		{
			public String getName(){return "一卡通通知开户";}
			public int getType(){return 9;}
			public int getContentType(){return 4;}	
		},
		INTEGRATEDMACHINE
		{
			public String getName(){return "一体机";}
			public int getType(){return 10;}
			public int getContentType(){return 1;}
		},
		MORNINGCHECKNORMAL
		{
			public String getName(){return "晨检结果正常";}
			public int getType(){return 11;}
			public int getContentType(){return 1;}
		},
		MORNINGCHECKABNORMAL
		{
			public String getName(){return "晨检结果异常";}
			public int getType(){return 11;}
			public int getContentType(){return 2;}
		},
		SETSCHEDULETIME
		{
			public String getName(){return "作息时间设置";}
			public int getType(){return 12;}
			public int getContentType(){return 1;}
		},
		TEACHEREVALUATE
		{
			public String getName(){return "幼儿园老师评价";}
			public int getType(){return 13;}
			public int getContentType(){return 1;}
		},
		RECIPE
		{
			public String getName(){return "食谱变动";}
			public int getType(){return 14;}
			public int getContentType(){return 1;}
		},
		TASKSENDPUSH
		{
			public String getName(){return "作业发布";}
			public int getType(){return 15;}
			public int getContentType(){return 1;}
		},
		SCHOOLNEWS
		{
			public String getName(){return "校园新闻";}
			public int getType(){return 16;}
			public int getContentType(){return 1;}
		},
		SCHOOLACTIVITY
		{
			public String getName(){return "校园活动";}
			public int getType(){return 16;}
			public int getContentType(){return 2;}
		},
		SCHOOLRECRUITMENT
		{
			public String getName(){return "校园招生信息";}
			public int getType(){return 16;}
			public int getContentType(){return 3;}
		},
		PARENTCLASS
		{
			public String getName(){return "家长课堂";}
			public int getType(){return 16;}
			public int getContentType(){return 4;}
		},
		CLASSACTIVITY
		{
			public String getName(){return "班级每日活动";}
			public int getType(){return 16;}
			public int getContentType(){return 5;}
		},
		CARDAPPLY
		{
			public String getName(){return "补办卡通知";}
			public int getType(){return 19;}
			public int getContentType(){return 1;}
		},
		BUYSERVICEFEE
		{
			public String getName(){return "服务费订购通知";}
			public int getType(){return 20;}
			public int getContentType(){return 1;}
		},
		SECURITYDANGER_STUDENT
		{
			public String getName(){return "学生行为";}
			public int getType(){return 22;}
			public int getContentType(){return 1;}
		},
		SECURITYDANGER_SCHOOL
		{
			public String getName(){return "学校资产";}
			public int getType(){return 22;}
			public int getContentType(){return 2;}
		}
		,
		AUTHUSER_APPLY
		{
			public String getName(){return "智慧校园用户申请";}
			public int getType(){return 23;}
			public int getContentType(){return 1;}
		},
		AUTHUSER_APPLY_SUCCESS
		{
			public String getName(){return "智慧校园申请成功通知";}
			public int getType(){return 23;}
			public int getContentType(){return 3;}
		},
		AUTHUSER_APPLY_FAIL
		{
			public String getName(){return "：智慧校园申请被拒绝";}
			public int getType(){return 23;}
			public int getContentType(){return 4;}
		},
		AUTHUSER_UPDATE
		{
			public String getName(){return "智慧校园用户申请修改信息";}
			public int getType(){return 23;}
			public int getContentType(){return 2;}
		},
		AUTHUSER_UPDATE_SUCCESS
		{
			public String getName(){return "智慧校园申请修改信息成功";}
			public int getType(){return 23;}
			public int getContentType(){return 5;}
		},
		AUTHUSER_UPDATE_FAIL
		{
			public String getName(){return "智慧校园申请修改信息被拒绝";}
			public int getType(){return 23;}
			public int getContentType(){return 6;}
		},
		AUTHUSER_DELETE
		{
			public String getName(){return "删除智慧校园用户";}
			public int getType(){return 23;}
			public int getContentType(){return 7;}
		},YIXINTOWISDOM
		{
			public String getName(){return "通知";}
			public int getType(){return 24;}
			public int getContentType(){return 1;}
		},
		ASSETREPAIR
		{
			public String getName(){return "资产维修通知";}
		...
		ASSETREPAIRREMINDER
		{
			public String getName(){return "资产催单通知";}
			public int getType(){return 21;}
			public int getContentType(){return 2;}
		},
		ASSETREPAIRAUDIT
		{
			public String getName(){return "资产审核通知";}
			public int getType(){return 21;}
			public int getContentType(){return 3;}
		},
		ASSETREPAIRAUDITPASS
		{
			public String getName(){return "资产审核通过通知";}
			public int getType(){return 21;}
			public int getContentType(){return 4;}
		},
		ASSETREPAIRAUDITREFU
		{
			public String getName(){return "资产审核不通过通知";}
			public int getType(){return 21;}
			public int getContentType(){return 5;}
		},
		ASSETREPAIRFINISH
		{
			public String getName(){return "资产维修完成通知";}
			public int getType(){return 21;}
			public int getContentType(){return 6;}
		}
		;
	 ...
	 * 每条短息的费用是多少 单位：元
	 */
	public static final Double THE_AVERAGE_COST_OF_EACH_SMS = 0.065;
	...
	public static final int LOGIN_APIKEY_ERROR_CODE = 8000;
	/**
	 * 图片地址
	 */
	...
	/**
	 * 学校网盘(七牛空间) teaching-res
	 */
	public static final String QINIU_BUCKETNAME_TEACHING_RES = "teaching-res";
	
	/**
	 * 学校网盘访问路径 teaching-res
	 */
	public static final String QINIU_BUCKETNAME_TEACHING_RES_URL = "http://ocb3z15mk.bkt.clouddn.com/";
	
	/**
	 * 学校网盘(七牛空间) rich-cloud
	 */
	public static final String QINIU_BUCKETNAME_RICH_CLOUD = "rich-cloud";
	
	/**
	 * 学校网盘访问路径rich-cloud
	 */
	public static final String QINIU_BUCKETNAME_RICH_CLOUD_URL = "http://o9fisdspi.bkt.clouddn.com/";
