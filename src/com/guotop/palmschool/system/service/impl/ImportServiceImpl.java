...
public class ImportServiceImpl extends BaseService implements ImportService
{
	...
	public List<ImportDetail> getSuccessImportDetailParent(){
		List<ImportDetail> list = getBaseDao().selectListByObject("Import.getSuccessImportDetailParent", null);
		return list;
	}
	...
	public List<ImportDetail> getNOUserIdImportDetailParent(){
		List<ImportDetail> list = getBaseDao().selectListByObject("Import.getNOUserIdImportDetailParent", null);
		return list;
	}
	...
	public void updateImportDetail(Integer userId,Integer id){
		...
		parmMap.put("id", id);
		getBaseDao().updateObject("Import.updateImportDetail", parmMap);
	}
}
