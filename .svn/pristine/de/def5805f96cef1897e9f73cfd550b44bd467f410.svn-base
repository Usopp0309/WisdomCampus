	                            ...
	                            <div class="portlet-body m_overflow_hidden form-horizontal">
	                                <div class="col-md-6 col-sm-12 col-lg-8">
	                                	<div class="row">
	                                		...
	                                		<div class="col-md-12 col-sm-12 col-lg-6">
	                                			<div class="form-group">
	                                                <label class="control-label col-md-4 col-lg-3">姓名<span style="color: red;">*</span></label>
	                                                <div class="col-md-8 col-lg-9">
	                                	...
	                                	<div class="row">
	                                		<div class="col-md-12 col-sm-12  col-lg-6">
	                                			<div class="form-group">
	                                                <label class="control-label col-md-4 col-lg-3">班级<span style="color: red;">*</span></label>
	                                                <div class="col-md-8 col-lg-9">
	                                ...
	                                <div class="row">
	                                		<div class="col-md-12 col-sm-12" id="studengtCard">
	                                			<div class="form-group cardDiv">
	                                                <label class="control-label col-md-3 col-lg-3">卡号</label>
	                                                <div class="col-md-7 col-lg-7">
	                                                    <input type="text" class="form-control" size="16" name="cardCode"/>
	                                                </div>
	                                                <div class="col-md-2 col-lg-2">
	                                                    <a href="javascript:void(0);"  class="btn btn-icon-only green" onclick="appendCardAdd(this)">
					                                ...
					                                <div class="portlet-body">
                                						<div class="col-md-6 col-sm-6 col-lg-5">
                                							<div class="form-group m_overflow_hidden">
				                                                <label class="control-label col-md-3 col-lg-4">绑定手机号</label>
				                                            ...
				                                            <div class="form-group m_overflow_hidden">
				                                                ...
				                                                <div class="col-md-9 col-lg-8">
				                                                    <input type="text" class="form-control" placeholder="默认手机号" name="parent1Passwoed" id="parent1Passwoed"/>
				                                                </div>
				                                            </div>
                                						</div>
                                						<div class="col-md-6 col-sm-6 col-lg-7" id="parent1">
                                							<div class="form-group m_overflow_hidden cardDiv">
				                                                <label class="control-label col-md-3 col-lg-4">电子卡</label>
				                                                <div class="col-md-7 col-lg-6">
				                                                    <input type="text" class="form-control" name="cardCode"/>
				                                                </div>
				                                                <div class="col-md-2 col-lg-2">
				                                                    <a href="javascript:;" class="btn btn-icon-only green"  onclick="appendParentCardAdd(this)">
                                                                        <i class="fa fa-plus"></i>
                                                                    </a>
				                                                </div>
				                                            </div>
					                                ...
					                                <div class="portlet-body">
                                						<div class="col-md-6 col-sm-6">
				                                            ...
				                                            <div class="form-group m_overflow_hidden">
				                                                <label class="control-label col-md-3 col-lg-4">密码</label>
				                                                <div class="col-md-9 col-lg-8">
				                                                    <input type="text" class="form-control"  placeholder="默认手机号" name="parent2Passwoed" id="parent2Passwoed" />
				                                                </div>
				                                            </div>
                                						</div>
...
<!--                             <div class="portlet box green m_margin_15_auto_0"> -->
<!-- 	                            <div class="portlet-title"> -->
<!-- 	                                <div class="caption"><i class="fa fa-list"></i>家长接收短信添加</div> -->
<!-- 	                            </div> -->
<!-- 	                            <div class="portlet-body m_overflow_hidden form-horizontal"> -->
<!-- 	                                <div class="row"> -->
<!-- 	                                		<div class="col-md-6 col-sm-6 col-lg-4"> -->
<!-- 		                                		<div class="form-group m_overflow_hidden phoneDiv"> -->
<!-- 	                                                <label class="control-label col-md-3">家长1手机号</label> -->
<!-- 	                                                <div class="col-md-7"> -->
<!-- 	                                                    <input type="text" class="form-control"/> -->
<!-- 	                                                </div> -->
<!-- 	                                                <div class="col-md-2"> -->
<!-- 	                                                    <a href="javascript:;" class="btn btn-icon-only green" onclick="appendRecivePhoneAdd(this)"> -->
<!--                                                          <i class="fa fa-plus"></i> -->
<!--                                                          </a> -->
<!-- 	                                                </div> -->
<!-- 	                                            </div> -->
	...
	<script>
		...
		function saveData(){
			...
			if(validate()){
			 ...
			 var data={"code":code,"name":name,"classId":clazzSelect,"type":type,"studentCard":studentCard.join(","),
		...
		function appendRecivePhoneAdd(obj)
		{
				var	appendHtml ='<div class="form-group">';
				appendHtml +='<label class="control-label col-md-3 col-lg-3"></label>';
				appendHtml +='<div class="col-md-7 col-lg-7">';
				appendHtml +='<input class="form-control" type="text" size="16" name="revicePhone">';
				appendHtml +='</div>';
				appendHtml +='<div class="col-md-2 col-lg-2">';
				appendHtml +='<a href="javascript:void(0);" onclick="removeRecivePhone(this)" class="btn btn-icon-only grey-cascade">';
				appendHtml +='<i class="fa fa-minus"></i>';
				appendHtml +='</a>';
				appendHtml +='</div>';
				$(obj).closest(".phoneDiv").after(appendHtml);
		}
		
		function appendParentCardAdd(obj)
		{
				var	appendHtml ='<div class="form-group">';
				appendHtml +='<label class="control-label col-md-3 col-lg-4"></label>';
				appendHtml +='<div class="col-md-7 col-lg-6">';
				appendHtml +='<input class="form-control" type="text" size="16" name="cardCode">';
				appendHtml +='</div>';
				appendHtml +='<div class="col-md-2 col-lg-2">';
				appendHtml +='<a href="javascript:void(0);" onclick="removeCardAdd(this)" class="btn btn-icon-only grey-cascade">';
			...
			function removeRecivePhone(obj)
			{
			 		$(obj).parent().parent().remove();
			}
			//判断学生学号
