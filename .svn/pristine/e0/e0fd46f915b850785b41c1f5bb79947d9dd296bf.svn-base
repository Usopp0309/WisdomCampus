                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="portlet box green m_margin_15_auto_0" >
                                ...
                                <div class="portlet-body">
                                    <form action="<%=basePath%>teacherImport/onUploadTeacher.do" id="upload" class="form-horizontal" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                        <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <input type="button" onclick="submitTeacher()" class="btn green" value="确定"/>
				...
				success: function(data){
					...
					$.each(page.list, function(n, value) {  
						...
						<c:if test="${sessionScope.user.userId==1}">
							if(value.status == 0){
								appendHtml += '<td><a class="btn btn-sm red teacher_import_del" onclick="delImportUser('+value.id+');">删除</a></td>';
							}else{
								appendHtml += '<td>-</td>';
							}
						</c:if>
