                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 radio-list">
                                                        <label style="padding-left: 20px;" class="radio-inline">
                                                            <div style="min-height:0;" class="radio" id="zuoye"><input name="type" id="zuoye"  checked="" type="radio"  value="1"></div>作业下发</label>
                                                        <label class="radio-inline">
                                                            <div style="min-height:0;" class="radio" id="chengji"><input name="type" id="chengji"  value="2"  type="radio"onclick="returnAchievement()"></div>成绩下发</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">`
                                                    <a href="<%= basePath %>templet/作业模板.xls"><img style="width:40px; height:40px" alt="" src="<%= basePath %>assets/global/img/m_img/excel.png"> 点击下载发送模板</a>
                                                </div>
                                            </div>
                                        </div>
