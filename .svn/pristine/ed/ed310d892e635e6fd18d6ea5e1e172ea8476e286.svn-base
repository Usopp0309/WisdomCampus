...
//	    return weeks[week_index]; 
    ...
    public static int compare_date(String date1, String date2) {
        ...
        try {
            ...
            if (dt1.getTime() > dt2.getTime()) {
            	...
            	//两个时间间隔不能超过3天
            	if(dt2.getTime() - dt1.getTime() >= 3*24*60*60*1000){
            		return -2;
            	}
                return 0;
            } else {
	...
	public static void main(String[] args) throws ParseException
	{
		...
		Long interval = formatter2.parse("2017-01-01").getTime()-formatter2.parse("2016-12-29").getTime();
		int dates = 1;
		if(interval == 0l){
			//没有间隔时间
			dates = 1;
		}else if(interval > 0l){
			dates = ((int) (interval/(24*60*60*1000))) + 1;
		}
