...
<body>
	...
	<div class="app_head">
		<i class="  m_icon-return icon_left" onclick="returnHis()"></i>电子课程表
	</div>
...
<%-- 										<p>${ns.subjectsUserName}</p> --%>
	...
	<div class="select_role">
	 ...
	 <div class="modal fade bs-modal-sm" id="static1" tabindex="-1" role="dialog" aria-hidden="true">
	...
	$(function() { 
		...
		$("#submenu").on("click",function(){
	    	...
	    	standardPost('<%=basePath%>curriculum/toSetCurriculumHuXin.do',{roleCode:roleCode});
		})
