...
<div class="template_bg">
	<div class="container-fluid">
					...
					<div class="archive_Actions actions12">
					...
					<a href="#static1" data-toggle="modal"><i
						class="add_info archive12_add_01"></i></a> <a href="#static2"
						data-toggle="modal"><i class="add_info archive12_add_02"></i></a>
					<img src="" class="archive12_img_01"> <img src=""
						class="archive12_img_02">
					<div class="list_page archive12page">
		...
		<a class="tprev" href="<%=basePath %>jsp/growthArchives/archive11.jsp"
			target="archive_page"></a> <a class="tnext"
			href="<%=basePath %>jsp/growthArchives/archive13.jsp"
	...
	jQuery(document).ready(function(){
		...
		$(".archive_bg").prepend("<img class='img_model' src='<%=basePath%>media/Template/"+path+"/12.png'>");
		$(".archive12_img_01").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive12_img_02").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png")
			...
			success: function(data){
				...
				if (list != null){
					$.each(list,function(n,value){
							...
							$(".archive12_img_01").attr("src",value.firstImgPath);
							$(".archive12_img_02").attr("src",value.secondImgPath);
							return false;
					});
				}
	...
	$(".archive12_img_0"+index).attr("src",$("#priview"+index+" > img").attr("src"));
	...
	function save(){
		...
		$.ajaxFileUpload({
			...
			data:{
				...
				modal : 'mySchool',
				img1Path : $(".archive12_img_01").attr("src"),
				img2Path : $(".archive12_img_02").attr("src")
			},
			dataType : 'json',
	...
	function getImgList(index){
		...
		function setThisImg(index, obj) {
			$(".archive12_img_0" + index).attr("src", obj.src);
			$("#static" + index).modal("hide");
		}
	</script>
	<script type="text/javascript">
