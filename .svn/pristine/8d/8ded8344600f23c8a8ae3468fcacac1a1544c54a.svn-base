                            ...
                            <div class="portlet light portlet-fit portlet-form bordered m_margin_15_auto_0" >
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">排查人员添加</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
<%--                                     <form action="<%=basePath %>securityDanger/addDangersAcceptPerson.do" class="form-horizontal" method="post" > --%>
										...
										<div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">排查类型：</label>
                                                <div class="col-md-9 col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-lg-3">添加对象：</label>
                                                ...
                                                <div class="col-md-4 col-lg-2">
													<select class="form-control sms_select" multiple="multiple" id="selectedObj" ></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
													<button type="button" class="btn" id="addRecept">添加</button>
													<button type="button" class="btn blue" id="back">返回</button>
	...
	<script>
		jQuery(document).ready(function() {  
			...
			$("#addRecept").click(function(){
				...
				$.ajax({
					type: "post",
					url: "<%=basePath%>securityDanger/addDangersAcceptPerson.do",
					data:{
							userIdStr : selectedValues.join(","),
							type : type
						},
					success: function(data){
						if(data==1){
							...
							layer.msg("添加成功");
							window.location.href="<%=basePath%>securityDanger/toDangerPersonList.do"
						}
					},
				});
			});
