...
<body>
         ...
         <div class="select_role" style="height:50px;width:50px;left:3%;"data-toggle="modal" data-target="#add_info" onclick="setVal(0);">
	...
	<!--公共js结束--> 
	<!-- 百度地图定位API 开始 -->
	<script type="text/javascript" src="https://api.map.baidu.com/api?v=2.0&ak=MnblP7QGUnaYv50psbrm3Dgt"></script> 
	<!-- 百度地图定位API 结束--> 
