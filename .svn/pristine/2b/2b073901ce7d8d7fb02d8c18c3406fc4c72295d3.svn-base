...
public class AnnouncementController extends BaseController
{
	...
	public void doAddAnnouncement(HttpServletRequest request, HttpSession session,HttpServletResponse response)
	{
		...
		if (String.valueOf(Cons.ANNOUNCEMENT_SCHOOL).equals(type))
		{
			// 是学校公告
		 ...
		 * 部门公告
		 */
		else if (String.valueOf(Cons.ANNOUNCEMENT_DEPARTMENT).equals(type))
		{
			// 操作对象
		 ...
		 * 班级公告
		 */
		else if (String.valueOf(Cons.ANNOUNCEMENT_CLAZZ).equals(type))
		{
			// 操作对象
			...
			// 获取班级所有人员id列表
			list = clazzService.getParentListByClazzId(clazzId);
		}
		/*
		 * 系统公告
		 */
		else if (String.valueOf(Cons.ANNOUNCEMENT_SYSTEM).equals(type))
		{
			// 系统公告
