...
<div class="template_bg">
			...
			<div class="row-fluid">
				<div class="archive_bg">
					<div class="archive_Actions actions13">
					...
					<a href="#static2" data-toggle="modal"><i
						class="add_info archive13_add_01"></i></a> <a href="#static1"
						data-toggle="modal"><i class="add_info archive13_add_02"></i></a>
					<a href="#static3" data-toggle="modal"><i
						class="add_info archive13_add_03"></i></a> <img src=""
						class="archive13_img_01"> <img src=""
						class="archive13_img_02"> <img src=""
						class="archive13_img_03">
					<div class="list_page archive13page">
		...
		<a class="tprev" href="<%=basePath %>jsp/growthArchives/archive12.jsp"
			target="archive_page"></a> <a class="tnext"
			href="<%=basePath %>jsp/growthArchives/archive14.jsp"
	...
	jQuery(document).ready(function(){
		...
		$(".archive_bg").prepend("<img class='img_model' src='<%=basePath%>media/Template/"+path+"/13.png'>");
		$(".archive13_img_01").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive13_img_02").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive13_img_03").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png")
		loadImgs();
		loadAlbum();
			...
			success: function(data){
				...
				if (list != null){
					$.each(list,function(n,value){
							...
							$(".archive13_img_01").attr("src",value.firstImgPath);
							$(".archive13_img_02").attr("src",value.secondImgPath);
							$(".archive13_img_03").attr("src",value.thirdImgPath);
							return false;
					});
				}
	...
	$(".archive13_img_0"+index).attr("src",$("#priview"+index+" > img").attr("src"));
	...
	function save(){
		...
		$.ajaxFileUpload({
			...
			data:{
				...
				modal : 'themeActivity',
				img1Path : $(".archive13_img_01").attr("src"),
				img2Path : $(".archive13_img_02").attr("src"),
				img3Path : $(".archive13_img_03").attr("src")
			},
			dataType : 'json',
	...
	function getImgList(index){
		...
		function setThisImg(index, obj) {
			$(".archive13_img_0" + index).attr("src", obj.src);
			$("#static" + index).modal("hide");
		}
	</script>
