...
<body class="page-header-fixed" onload="showbody(${titleid})">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							...
							<form action="#" id="submitForm" class="form-horizontal" method="post">
								...
								<tr>
									<td colspan="5" align="center"><span class="font-weight">${asd }老师的评价</span></td>
								</tr>
								<tr >
									<td colspan="1" rowspan="2" style="width:70%" align="center"><span class="font-weight">问卷内容</span></td>
									<td colspan="4" style="width:30%;" align="center"><span class="font-weight">考评值</span></td>
								</tr>
								<tr>
								...
								<tr height="30">
									<td colspan="1"  rowspan="2">${asd }老师评论得分统计表</td>
								...
								<tr>
								   <td colspan="5"><span class="font-weight">下面是学生们给${asd }老师的一些建议:</span></td>
								</tr>
								
								<c:forEach var="e" items="${elist }" varStatus="start2">
									<tr >
										...
										<td colspan="5">
											...
											<span onclick="opendivshow(${e.id},${formid })">
											<b class="red">点击查看</b>
											</span>
										</td>
										</c:if>
	...
	<script>
		...
		function opendivshow(tid,fid){
			standardPost('<%=basePath%>evaluation/toTeacherEvaluationViewDetail.do',{titleid:tid,id:fid});
		}

		function showbody(a){
			if(typeof(a)!='undefined'){
				openDivPage('700','400','1','学生的心里话');
			}
		}
