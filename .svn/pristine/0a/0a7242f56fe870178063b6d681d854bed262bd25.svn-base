                ...
                <div class="page-content m_overflow_hidden m_page_content">
                    ...
                    <div class="page-bar m_margin_0_0_0_0">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>[换班]导入学生页面</span></li>
                        </ul>
                    </div>
                    <h3 class="page-title">[换班]导入学生页面</h3>
                    <div class="row">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered m_margin_15_auto_0" id="form_wizard_1">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">[换班]导入学生页面</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3">
                                                	<a href="<%=basePath%>templet/幼儿园_小班.xls">模板下载</a>
                                                </div>
                                                <div class="col-md-2 col-sm-2">${errormsg}</div>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                	<button type="button" class="btn green" onclick="importStudent();">导入</button>
