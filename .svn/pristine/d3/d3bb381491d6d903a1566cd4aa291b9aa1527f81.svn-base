			...
			<div id="loginBlock" class="login tab-1">
				<div class="loginForm">
					<form class="form-vertical login-form" action="" method="post" id="form">
						...
						<p style="line-height:30px;margin:0px auto">还没有账号？ 
						<a href="<%=basePath%>apply/apply.do" style="color:#3986ef;">在线申请</a> 
						<a href="javascript:addDownLoadNum();" style="color:#808080;float:right;"><i class="fa fa-mobile-phone" style="font-size:17px;margin:0px 5px 0 0"></i>APP下载</a>
						<a href="http://o9fisdspi.bkt.clouddn.com/download/app/YiXin.apk"  style="display:none"><span id="downApp"></span></a>
						</p>
	...
	<div id="footer" class="footer Response">
		<div class="footer-inner" id="footerInner">
			<a target="_blank" href="http://www.richx.cn/" class="footerLogo">
				<img width="140" height="30" src="<%=basePath %>assets/global/img/m_img/rich1.png">
			</a>
			...
			<div class="footerNav">
				<p>      
					...
					<span><a href="http://www.richx.cn/pc/product.html?name=WisdomSchool" target="_blank"><em class="Response">关于</em>智慧校园</a></span>
