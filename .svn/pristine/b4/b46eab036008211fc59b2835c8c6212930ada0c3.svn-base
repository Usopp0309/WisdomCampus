...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>media/css/fancybox/jquery.fancybox-1.3.4.css"
	media="screen"></link>
<link rel="stylesheet"
	href="<%=basePath%>media/js_m/datetimepicker/jquery.datetimepicker.css" />
<link href="<%=basePath%>media/metronic_css_m/system_m.css"
...
<div class="template_bg">
			...
			<div class="row-fluid">
				<div class="archive_bg">
					<div class="archive_Actions actions11">
					...
					<a href="#static1" data-toggle="modal"><i
						class="add_info archive11_add_01"></i></a> <a href="#static2"
						data-toggle="modal"><i class="add_info archive11_add_02"></i></a>
					<a href="#static3" data-toggle="modal"><i
						class="add_info archive11_add_03"></i></a> <img src=""
						class="archive11_img_01"> <img src=""
						class="archive11_img_02"> <img src=""
						class="archive11_img_03">
					<div class="archive11_info" style="display: none">
						<p contenteditable="true" id="content"></p>
					</div>
					<div class="list_page archive11page">
			...
			<div data-keyboard="false" data-backdrop="static" tabindex="-1"
				class="modal hide fade" id="static3">
				<div class="modal-header">
						...
						<div class="span12">
							...
							<div class="tabbable tabbable-custom">
								...
								<ul class="nav nav-tabs">
									...
									<li class="active"><a data-toggle="tab" href="#tab_3_1">从本地上传</a></li>

									<li><a data-toggle="tab" href="#tab_3_2">从相册选择</a></li>
								...
								<div class="tab-content">
									...
									<div id="tab_3_1" class="tab-pane active">
											...
											<div class="fileupload fileupload-new"
												...
												<div>
													...
													<span class="btn btn-file"><span
														class="fileupload-new">选择图片</span> <span
														class="fileupload-exists">修改图片</span> <input type="file"
														class="default" id="imgFile3" name="file" /></span> <a href="#"
														class="btn fileupload-exists" data-dismiss="fileupload">删除图片</a>
										...
										<div class="modal-footer">
											<button class="btn green" type="button" onclick="saveImg(3)">提交</button>
											<input type="hidden" id="userDetailId" value="">
										</div>
									</div>
									<div id="tab_3_2" class="tab-pane">
											...
											<div class="span12 form-horizontal">
												<div class="control-group">
													...
													<div class="controls" style="margin-left: 80px;">
														...
														<select name="category" class="span3 m-wrap"
															id="albumSelect3" onchange="getImgList(3)">
										...
										<div class="row-fluid">
											<div class="span12">
												<ul class="select_img" id="photoList3">
												</ul>
											</div>
										</div>
										<div class="row-fluid">
		...
		<a class="tprev" href="<%=basePath %>jsp/growthArchives/archive10.jsp"
			target="archive_page"></a> <a class="tnext"
			href="<%=basePath %>jsp/growthArchives/archive12.jsp"
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		$(".archive_bg").prepend("<img class='img_model' src='<%=basePath%>media/Template/"+path+"/11.png'>");
		$(".archive11_img_01").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive11_img_02").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive11_img_03").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png")
			...
			success: function(data){
				...
				if (list != null){
					$.each(list,function(n,value){
							...
							$(".archive11_img_01").attr("src",value.firstImgPath);
							$(".archive11_img_02").attr("src",value.secondImgPath);
							$(".archive11_img_03").attr("src",value.thirdImgPath);
							return false;
					});
				}
	...
	$(".archive11_img_0"+index).attr("src",$("#priview"+index+" > img").attr("src"));
	...
	function save(){
		...
		$.ajaxFileUpload({
			...
			secureuri : false,
			fileElementId :[ 'imgFile1','imgFile2','imgFile3'],
			data:{
				growthId : growthId,
				type : 2,
				contentId : $("#contentId").val(),
				content : $("#content").text(),
				modal : 'familyActivities',
				img1Path : $(".archive11_img_01").attr("src"),
				img2Path : $(".archive11_img_02").attr("src"),
				img3Path : $(".archive11_img_03").attr("src")
			},
			dataType : 'json',
	...
	function getImgList(index){
		...
		function setThisImg(index, obj) {
			$(".archive11_img_0" + index).attr("src", obj.src);
			$("#static" + index).modal("hide");
		}
</script>
</html>