		                                ...
		                                <div class="portlet-title">
                               			...
                               			<div class="portlet-body">
			                            	<form action="<%=basePath%>asset/doAddAsset.do" method="post" id="addForm">
			                            	         <input name="isBluetooth" id="isBluetooth" value="0" type="hidden">
		                                    		<div class="row m_margin_10_auto search_box">
								                         	...
								                         	<div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15">
								                         		...
								                         		<select class="form-control m_select" name="type" id="type" onchange="changeType(this);">
					                                            </select>
								                         	</div>
								                         	<div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15">
								                         	...
								                         	<div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15">
								                         		...
								                         		<input class="m_input form-control asset_num" name="count" id="count" type="number">
								                         	</div>
								                         	<div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15">
								                         		<span class="m_span">单价</span>
								                         		<input class="m_input form-control asset_price" name="price" id="price" type="number">
								                         	</div>
								                         	<div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15">
								                        ...
								                        <div class="row m_margin_10_auto search_box" id="lanya_" style="display: none;">
								                         <div class="col-md-4 col-sm-4 col-lg-4 m_margin_top-15 m_text_align_conter" style="padding-top:5px;">
								                                <input type="radio" value="0" checked="checked" name="isBluetoothButton" onclick="chooseLanYa(0);">非蓝牙设备
								                         		<input type="radio" value="1" name="isBluetoothButton" onclick="chooseLanYa(1);">蓝牙路由器
								                         		<input type="radio" value="2" name="isBluetoothButton" onclick="chooseLanYa(2);">蓝牙手环
								                         	</div>
								                         </div>
							                         <hr class="m_hr">
...
<script type="text/javascript">
    ...
    function validate(){
			...
			if(asset_num=="" || asset_num < 1 || asset_num > 100000){
				layer.tips('请输入正确的数量', '.asset_num');
				return false;
			}
			if(asset_price=="" || asset_price < 0 || asset_price > 99999999){
				layer.tips('请输入正确的单价', '.asset_price');
				return false;
			}
			if(asset_place==""){
    ...
    function chooseLanYa(value){
    	$("#isBluetooth").val(value);
    }
