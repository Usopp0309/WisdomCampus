...
public class UnifiedOrderReqData
{
     ...
     */
    public UnifiedOrderReqData(String body,String attach,String outTradeNo,Integer totalFee,String deviceInfo,String spBillCreateIP, String tradeType, String notifyUrl,String productId){
    ...
    private  String getSign(Map<String,Object> map){
        ...
        String result = MD5Encode(test).toUpperCase();
    ...
    private String MD5Encode(String origin) {
        ...
        try {
            ...
            resultString = MD5.byteArrayToHexString(md.digest(resultString.getBytes("UTF-8")));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return resultString;
