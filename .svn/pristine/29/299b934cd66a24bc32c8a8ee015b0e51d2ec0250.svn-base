...
public class CurriculumServiceImpl extends BaseService implements CurriculumService
{
	...
	public List<CurriculumSemester> getCurriculumSemesterByClazzId(int clazzId) {
		return  (List<CurriculumSemester>) getBaseDao().selectList("Curriculum.getCurriculumSemesterByClazzId", clazzId);
	}

	@Override
	public void deleteCurriculumByClazzIdAndSemesterId(Map<String, Object> paramMap) {
		getBaseDao().deleteObject("Curriculum.deleteCurriculumByClazzIdAndSemesterId", paramMap);
	}

	@Override
	public void deleteCurriculumTimeById(int id) {
		getBaseDao().deleteObjectById("Curriculum.deleteCurriculumTimeById", id);
	}
}
