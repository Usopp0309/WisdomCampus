	                                ...
	                                <table class="table table-bordered table-hover" id="sample_1">
	                                    <thead class="flip-content">
	                                        <tr>
												...
												<th class="m_width_15 hidden-sm hidden-md">卡号</th>
												<th class="m_width_10 hidden-sm hidden-md">班级</th>
												<th class="m_width_15 hidden-sm hidden-md">班主任</th>	
			...
			$.ajax({
				...
				success: function(data){
					...
					$.each(data.list,function(n,value){
						...
						appendHtml += '<td class="hidden-sm hidden-md">' + value.cardCode + '</td>';
						appendHtml += '<td>' + value.clazzName + '</td>';
						appendHtml += '<td class="hidden-sm hidden-md">' + value.leaderName + '</td>';
						appendHtml += '<td class="hidden-sm hidden-md">' + value.teacherName + '</td>';
						appendHtml += '<td>' + value.parentPhone + '</td>';
						if (value.state==0){
							appendHtml += '<td><span class="normal">正常</span></td>';
						}else{
							appendHtml += '<td><span class="unnormal">异常</span></td>';
						}
						...
						appendHtml += '<td><a href="javascript:;" onclick="showDetail('+ value.id +')" class="btn btn-sm detail_btn">详情</a></td>';
						appendHtml += '</tr>';
					});
