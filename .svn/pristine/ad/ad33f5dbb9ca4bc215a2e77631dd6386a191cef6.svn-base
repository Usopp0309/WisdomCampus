...
public class StringUtil
{
	...
	{
		byte[] array1=new byte[]{83, 85, 80, 69, 82, 46, 51, 53, 48, 57, 48, 50, 48, 48, 50, 55, 48, 51};
		byte[] array2=new byte[]{83, 85, 80, 69, 82, 46, 51, 53, 48, 57, 48, 50, 48, 48, 50, 55, 48, 52};
		byte[] array3=new byte[]{83, 85, 80, 69, 82, 46, 51, 53, 48, 57, 48, 50, 48, 48, 50, 55, 48, 49};
		
		String result1 = new String(array1);
		System.out.println(result1);
		String result2 = new String(array2);
		System.out.println(result2);
		String result3 = new String(array3);
