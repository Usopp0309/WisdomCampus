								...
								<div class="portlet light portlet-fit portlet-form bordered m_margin_15_auto_0">
									<div class="portlet-title">
                             			<div class="caption">
	                                        ...
	                                        <span class="caption-subject font-green sbold uppercase">已评或未评学生</span>
                                    	</div>
                        			 </div>
<!-- 									<div class="portlet-title"> -->
...
// 			App.init();
			loadSubMenu("evaluationManager");
			 setActive("evaluationManager","studentEvaluationDetailManager");
			//选择第一个tab
			...
			$("#clazzSelect").change(function(){
				...
				standardPost('<%=basePath%>evaluation/toStudentEvaluationDetail.do',{clazzId:clazzId});
			});
		...
		function showt(c)
		{
			standardPost('<%=basePath%>evaluation/toStudentEvaluationByTeacher.do',{formid:'+c+'});
		}
 </script>
</html>