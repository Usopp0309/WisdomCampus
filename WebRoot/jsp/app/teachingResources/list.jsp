...
<body style="padding:0px 10px;">
	...
	jQuery(document).ready(function() {    
		...
		$("#search").on("click",function(){
			...
			standardPost('<%=basePath%>jsp/app/teachingResources/search_app.jsp',{apiKey:apiKey,schoolId:schoolId});
		}) 
		//上传 
		$("#buttonUpload").on("click",function(){
			...
			var schoolId = $("#schoolId").val();
			//var roleCode = $("#roleCode").val();
			standardPost('<%=basePath%>jsp/app/teachingResources/upload.jsp',{apiKey:apiKey;schoolId:schoolId});
		})  
	});
	//加载手机页面
	function showList(){
