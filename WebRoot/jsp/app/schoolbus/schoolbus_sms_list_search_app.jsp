...
<body>
	...
	<div class="app_head">
		<i class="m_icon-return icon_left" onclick="history.go(-1);"></i>校车短信搜索
	</div>
	<div class="app_search">
	
		<form action="<%=basePath%>schoolbusSms/toSchoolBusSmsByHuxinId.do" class="form-horizontal" method="post">
			...
			<span>选择日期</span>
			<p>
				<input readonly="readonly" name="time" id="startday" type="text">
			</p>
	...
	<script type="text/javascript">
	    ...
	    $("#startday").mobiscroll($.extend(opt['date'], opt['default']));
