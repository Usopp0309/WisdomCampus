						...
						<tbody>
							...
							<tr class="morning">
								...
								<td class="bg">
									<input readonly="readonly"  placeholder="下课时间" name="endTimeAm" class="title_input add_title" id="endTimeAm1" />
								 	<a class="btn blue" onclick="appendAddAm()"><i class="icon-plus"></i></a>
								</td>
							</tr>
							<tr>
							...
							<tr class="afternoon">
								...
								<td class="bg">
									...
									<a class="btn blue" onclick="appendAddPm()"><i class="icon-plus"></i></a>
								</td>
							</tr>
						</tbody>
					</table>
	        ...
	        <div class="modal-content">
	        	<div class="modal-header">
	                ...
	                <div class="modal-footer">
	                    <button type="button" class="btn dark btn-outline" id="editSub"  data-dismiss="modal">确定</button>
	...
	<script type="text/javascript">
		$(function() {   
		    ...
		    $("#cancel").on("click",function(){
				...
				var clazzId = $("#clazzId").val();
				standardPost('<%=basePath%>todayActivity/toTodayActivityHuXin.do',{apiKey:apiKey,schoolId:schoolId,roleCode:roleCode,clazzId:clazzId});
			})
		...
		function appendAddAm(){
			...
			appendHtml += '<a class="btn blue" onclick="removeAddAm($(this));"><i class="icon-minus"></i></a>';
			appendHtml += '</td>';
			appendHtml += '</tr>';
		...
		function appendAddPm(){
			...
			appendHtml += '<a class="btn blue" onclick="removeAddPm($(this));"><i class="icon-minus"></i></a>';
			appendHtml += '</td>';
			appendHtml += '</tr>';
