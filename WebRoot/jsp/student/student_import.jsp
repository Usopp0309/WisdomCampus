                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="portlet box green m_margin_15_auto_0" >
                                ...
                                <div class="portlet-body">
                                    <form action="<%=basePath%>studentImport/onUploadStudent.do" class="form-horizontal" id="upload" name="upload" accept-charset="UTF-8" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                	<span><a href="<%=basePath%>templet/grade_clazz.xls" class="btn red">模板下载</a></span>
                                                	<span >说明：grade_clazz.xls(格式必须类似于: 班级_年级.xls 如：一年级_一班.xls)</span>
                                                </div>
                                            </div>
				...
				success: function(data){
					...
					$.each(page.list, function(n, value) {  
						...
						<c:if test="${sessionScope.user.userId==1}">
							if(value.status == 0){
								appendHtml += '<td><a class="teacher_import_del btn btn-sm delete_btn" onclick="delImportUser('+value.id+');">删除</a></td>';
							}else{
								appendHtml += '<td>-</td>';
							}
						</c:if>
