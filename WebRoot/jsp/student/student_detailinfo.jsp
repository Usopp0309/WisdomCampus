														...
														<div class="row-fluid">
															...
															<div class="span6 ">
																<div class="control-group">
																	...
																	<label class="control-label" for="firstName">学号:</label>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<span class="text bold" id="headTeacherName"></span>
...
<!--																	<a onclick="window.location.href='<%=basePath%>announcement/toAnnouncementList.do'" class="btn green"><i class="icon-share"></i> 更多</a>-->
	...
	<script>
		...
		jQuery(document).ready(function() {    
			...
			//加载学生详细信息
			loadStudentDetailInfo(studentId);
			//加载平安校园数据
			loadInoutList(studentId);
		});
		...
		function loadStudentInfo(studentId)
		{
			$.ajax({
				type: "post",
				url: "<%=basePath%>student/loadStudentInfoForStudentDetail.do",
				data:
				{
					studentId : studentId
				},
		        success:function(data){
		        	...
		        	//姓名(标题)
		        	$("#titleName").html(student.name);
		        	//姓名
		        	$("#name").html(student.name);
		        	//学号
		        	$("#code").html(student.code);
		        	//性别
		        	$("#sex").html(student.sex);
		        	//班级
		        	$("#clazzName").html(student.clazzName);
					//年级
		        	$("#gradeName").html(student.gradeName);
		        	//联系人
		        	$("#parentName").html(student.parentName);
		        	//联系电话
		        	$("#phone").html(student.phone);
		        	//班主任
		        	$("#headTeacherName").html(student.headTeacherName);
		        }
			});
		}

		//加载学生详细信息
		function loadStudentDetailInfo(studentId)
		{
			$.ajax({
				type: "post",
				url: "<%=basePath%>student/loadStudentDetailInfo.do",
				data:
				{
					studentId : studentId
				},
		        success:function(data){
                    ...
                    //生日
                    $("#birth").html(studentDetail.birth);
		        	//担任职务
		        	$("#ofJob").html(studentDetail.ofJob);
		        	//政治面貌
		        	$("#forPolitical").html(studentDetail.forPolitical);
		        	//籍贯
		        	$("#nativePlace").html(studentDetail.nativePlace);
		        	//身高
		        	$("#height").html(studentDetail.height);
		        	//体重
		        	$("#weight").html(studentDetail.weight);
		        	//视力
		        	$("#vision").html(studentDetail.vision);
		        	//入学时间
		        	$("#instime").html(studentDetail.insTime);
		        	//qq
		        	$("#qq").html(studentDetail.qq);
		        	//邮箱
		        	$("#email").html(studentDetail.email);
		        	//家庭住址
		        	$("#address").html(studentDetail.address);
		        	//获奖记录
		        	$("#rewards").html(studentDetail.rewards);       
		        }
			});
		}
