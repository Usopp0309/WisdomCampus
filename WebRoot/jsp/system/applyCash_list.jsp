	            ...
	            <div class="page-content m_overflow_hidden m_page_content">
	                ...
	                <div class="row">
	                    <div class="col-md-12 col-sm-12">
	                        ...
	                        <div class="portlet light form-fit bordered search_box">
	                         ...
	                         <div class="row m_margin_10_auto">
		                         ...
		                         <div class="col-md-4 col-sm-4 col-lg-3 m_margin_top-15">
		                         	...
		                         	<button type="button" class="btn btn-default" id="yixin">亦信列表</button>
		                         </div>
	                         </div>
	                        </div>
						    ...
						    <div class="modal fade" id="tianxianHtml" tabindex="-1" role="dialog" aria-hidden="true">
						        <div class="modal-dialog modal-lg" style="width: 400px;">
						            <div class="modal-content">
						                <div class="modal-header">
						                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						                ...
						                <div class="col-md-12 col-sm-12 col-lg-12 m_margin_top-15">
				                         <span class="m_display_inline m_float_left m_width_10">备注</span>
				                         <textarea class="m_width_90 m_float_left form-control" id="txremark" name="remark" placeholder="请输入提现信息(可不写)"></textarea>
			                            </div>
						                </div>
						                <div class="modal-footer">
						                <input value="" id="tianxianId" type="hidden">
						                <input value="" id="tianxianIduserId_" type="hidden">
						                <button type="button" class="btn green" onclick="tixian(this);">确定</button>
						                <button type="button" class="btn" data-dismiss="modal">取消</button>
						                </div> 
						            </div>
						        </div>
	...
	<script type="text/javascript">
		$(function() { 
			...
			$("#yixin").click(function(){
				standardPost('<%=basePath%>wallet/toYinApplyCashList.do',{});
			});
			...
			$("#export").click(function(){
				...
				standardPost('<%=basePath%>wallet/exportApplyCashUserList.do',{startTime:startTime,thirdType:thirdType,applyStatus:applyStatus,queryContent:queryContent,type:1});
			});
		})
					...
					$.each(pages.list, function(n, value) {
						...
						if(typeof(value.applyStatus)!="undefined"){
							if(value.applyStatus == 0){
								appendHtml += '<td><a class="btn green" data-toggle="modal" href="#tianxianHtml" onclick="brforeTianxian('+value.applyId+','+value.userId+')">提现</a>';
		...
		function brforeTianxian(applyId,userId){
			$("#txremark").val("");
			$("#tianxianId").val(applyId);
			$("#tianxianIduserId_").val(userId);
		}
		function tixian(obj){
			var applyId=$("#tianxianId").val();
			var userId=$("#tianxianIduserId_").val();
					...
					$.ajax({
						...
						success: function(data){
							...
							if(responseCode == 0){
								...
								layer.msg("服务器处理失败,请联系管理员",{icon:2,time:1000});
							}
						},
					});
				},function(){
