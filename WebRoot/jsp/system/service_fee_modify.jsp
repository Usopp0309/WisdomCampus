                                    ...
                                    <form action="<%=basePath%>replaceRecharge/doModifyMessage.do" id="submitForm" class="form-horizontal" method="post" >
                                        <div class="form-body">
                                            ...
                                            <div class="form-group" id="priceGroup">
                                                <label class="control-label col-md-3">服务费(元/人)</label>
                                                <div class="col-md-9 col-lg-4">
                                                    <input type="text" name="servicePrice" placeholder="服务费(无则输入0)" id="price" value="${message.servicePrice}" onkeyup="clearNoNum(this)" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group" id="priceGroup">
                                                <label class="control-label col-md-3">卡押金(张/元)</label>
                                                <div class="col-md-9 col-lg-4">
                                                 <input type="text" placeholder="卡押金(无则输入0)" name="cardPrice" id="cardPrice" value="${message.cardPrice }" onkeyup="clearNoNum(this)" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
		...
		jQuery(document).ready(function() {
          ...
          //初始化选择年级，如果select改动则将发送对象改为某个班级的所有学生的信息
			...
			$("#submitButton").click(function()
			{
				...
				{
				    $("#submitForm").submit();
				    layer.msg("正在保存数据……",{icon:16,time:5000,shade:0.4});
				}
			});
			changeStatus();
		});
