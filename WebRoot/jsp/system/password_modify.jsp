                ...
                <div class="page-content m_overflow_hidden m_page_content">
                    ...
                    <div class="page-bar m_margin_0_0_0_0">
                        <ul class="page-breadcrumb">
                            ...
                            <li><a href="<%=basePath%>user/toModifyPassword.do">系统管理</a><i class="fa fa-circle"></i></li>
			...
			jQuery(document).ready(function(){  
			    ...
			    $("#modify").click(function(){
	                ...
	                if(!flagoldPassword){
	                	layer.tips('原密码输入错误!', '#oldPassword');
						return false;
	                }else if(!flagnewPassword){
	                	 layer.tips('新密码的长度不能小于六位或不能为空', '#newPassword');
			              return false;
	                }else if(!flagconfirmPassword){
	                	layer.tips('确认密码不能为空或两次输入的不一致', '#confirmPassword');
			              return false;	
	                }
	            	if(true==flagnewPassword &&true==flagconfirmPassword)
		            {
		                //$("#submitForm").submit();
	                    $.ajax({
					    	type: "post",
