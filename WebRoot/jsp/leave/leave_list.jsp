...
<head>
	            ...
	            <div class="page-content m_overflow_hidden m_page_content">
	                ...
	                <div class="page-bar m_margin_0_0_0_0">
	                    <ul class="page-breadcrumb">
	                        ...
	                        <li><span>请假列表</span></li>
	                    </ul>
	                </div>
	                <h3 class="page-title">请假列表</h3>
	                <div class="row">
	                    <div class="col-md-12 col-sm-12">
	                        ...
	                        <div class="portlet light form-fit m_margin_0_0_15_0">
		                        <c:if test="${sessionScope.user.type != 2}">
										<button class="btn btn-default" type="button" id="addLeave">请假申请</button>
								</c:if>
	                        </div>
	                        <!-- 添加功能菜单结束 -->
	                        <!-- 页面搜索开始 -->
	...
	<script>
		$(function() { 
			...
			//加载初始化数据
			loadLeaveList(userId, roleCode, null);
			...
			$("#addLeave").click(function(){
				var userId = $("#userTab li.active").find('a').attr("attr1");	
				var roleCode = $("#userTab li.active").find('a').attr("attr2");
				standardPost('<%=basePath%>leave/toAddLeave.do',{userId:userId,roleCode:roleCode});
			});
		});
		...
		function loadLeaveList(userId, roleCode, cPage)
		{
			$.ajax({
				type: "post",
				url: "<%=basePath%>leave/getLeaveList.do",
				data:{
						userId : userId,
						roleCode : roleCode,
						cPage : cPage
