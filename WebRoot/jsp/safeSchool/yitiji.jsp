...
<head>
	                                        ...
	                                        <div class="form-actions">
	                                            <div class="row">
	                                                <div class="col-md-offset-3 col-md-9">
	                                                    <button type="button" class="btn design_btn" onclick="submitImgForm()" ><span id="send">提交</span></button>
	...
	<script>
		...
		function submitImgForm(){
			var imgFile1=$.trim($("#imgFile1").val());
			var imgFile2=$.trim($("#imgFile2").val());
			if(imgFile1==""){
				layer.tips("请选择图片！","#imgFile1");
				return false;
			 }else{
				 imgFile1=imgFile1.toLowerCase();
				 if(imgFile1.indexOf("png")!=-1 || imgFile1.indexOf("jpg")!=-1 || imgFile1.indexOf("bmp")!=-1 || imgFile1.indexOf("jpeg")!=-1){
					 
				  }else{
					layer.tips("请选择:png,jpg,bmp,jpeg格式的图片","#imgFile1");
					return false; 	  
				  }
			 }
			
			if(imgFile2==""){
				 layer.tips("请选择图片！","#imgFile2");
				 return false; 
			 }else{
				 imgFile2=imgFile2.toLowerCase();
				 if(imgFile2.indexOf("png")!=-1 || imgFile2.indexOf("jpg")!=-1 || imgFile2.indexOf("bmp")!=-1 || imgFile2.indexOf("jpeg")!=-1){
					 
				  }else{
					layer.tips("请选择:png,jpg,bmp,jpeg格式的图片","#imgFile2");
					return false; 	  
				  }
			 }
			var body = $("#body");
