...
<head>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered m_margin_15_auto_0">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">班级摄像头</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                   	<form action="<%=basePath%>camera/doSaveClazzCamera.do" class="form-horizontal" method="post" id="addSmsForm">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">班级摄像头</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3" for="inputError">选择对象</label>
                                                <div class="col-md-4 col-lg-2">
                                                    <select style="display : none" tabindex="1" name="clazzList" id="clazzList">
													</select>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-lg-2">
													...
													<select  multiple="multiple" tabindex="1" id="toSelectObj1" style="display : none">
													</select>	
                                                </div>
                                            </div>
                                        </div>
	...
	<script type="text/javascript">
		...
		function loadclazzList(userId, permissionCode)
		{
			$.ajax({
				type: "post",
				url: "<%=basePath%>clazz/getAllClazz.do",
				data:{
						userId : userId,
