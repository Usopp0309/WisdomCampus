                                    ...
                                    <form action="<%=basePath%>camera/doSaveUserCamera.do" class="form-horizontal" method="post" id="addSmsForm">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">班级摄像机</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">选择教职工:</label>
                                                <div class="col-md-9 col-lg-4">
...
// 			loadTeacherList();
			...
			$("#teacherList").click(function(){
				...
				{
					var appendHtml = $("#teacherList").html();
					$("#toSelectObj").html(appendHtml);
					$("#toSelectObj option[value='0']").remove();
					$("#toSelectObj1").html(appendHtml);
					$("#toSelectObj1 option[value='0']").remove();	
		...
		function loadDepartmentList(userId)
		{
			$.ajax({
				...
				data:{
						userId : userId,
						permissionCode : "cameraManager"
					},
				success: function(data){
					var departmentList = eval("(" + data + ")");
					
					var appendHtml = '<option value="0">--所有部门--</option>';
			...
			$.ajax({
				...
				data:{
				  ...
				  success: function(data){
					...
					var appendHtml = '<option value="0">--所有班级--</option>';
