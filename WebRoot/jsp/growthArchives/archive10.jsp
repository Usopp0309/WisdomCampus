...
<div class="template_bg">
			...
			<div class="row-fluid">
				<div class="archive_bg">
					<div class="archive_Actions actions10">
					...
					<a href="#static2" data-toggle="modal"><i
						class="add_info archive10_add_01"></i></a> <a href="#static1"
						data-toggle="modal"><i class="add_info archive10_add_02"></i></a>
					<img src="" class="archive10_img_01"> <img src=""
						class="archive10_img_02">
					<div class="archive10_info" style="display: none">
						<p contenteditable="true" id="content"></p>
					</div>
					<div class="list_page archive10page">
		...
		<a class="tprev" href="<%=basePath %>jsp/growthArchives/archive09.jsp"
			target="archive_page"></a> <a class="tnext"
			href="<%=basePath %>jsp/growthArchives/archive11.jsp"
	...
	jQuery(document).ready(function(){
		...
		$(".archive_bg").prepend("<img class='img_model' src='<%=basePath%>media/Template/"+path+"/10.png'>");
		$(".archive10_img_01").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png");
		$(".archive10_img_02").attr("src","<%=basePath%>media/Template/"+path+"/add_img.png")
		loadImgs();
			...
			success: function(data){
				...
				if (list != null){
					$.each(list,function(n,value){
							...
							$(".archive10_img_01").attr("src",value.firstImgPath);
							$(".archive10_img_02").attr("src",value.secondImgPath);
							return false;
					});
				}
	...
	$(".archive10_img_0"+index).attr("src",$("#priview"+index+" > img").attr("src"));
	...
	function save(){
		...
		$.ajaxFileUpload({
			...
			data:{
				...
				modal : 'myWork',
				img1Path : $(".archive10_img_01").attr("src"),
				img2Path : $(".archive10_img_02").attr("src")
			},
			dataType : 'json',
	...
	function getImgList(index){
		...
		function setThisImg(index, obj) {
			$(".archive10_img_0" + index).attr("src", obj.src);
			$("#static" + index).modal("hide");
		}
	</script>
