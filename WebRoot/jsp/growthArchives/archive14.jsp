...
<div class="archive_Actions actions14">
					...
					<div class="archive14_info">
						<p contenteditable="true" id="content"></p>
					</div>
					
					</div>
		<a class="tprev" href="<%=basePath %>jsp/growthArchives/archive13.jsp" target="archive_page"></a>
	    <a class="tnext" href="<%=basePath %>jsp/growthArchives/archive15.jsp" target="archive_page"></a>		
</div>
</body>
...
jQuery(document).ready(function(){
	...
	$(".archive_bg").prepend("<img class='img_model' src='<%=basePath%>media/Template/"+path+"/14.png'>");
