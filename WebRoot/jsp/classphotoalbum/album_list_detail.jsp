	                ...
	                <div class="row">
	                    <div class="col-md-12 col-sm-12">
	                        ...
	                        <div class="portlet light form-fit m_margin_0_0_15_0">
	                        	<span class="select_num_photo"><i></i>全选/取消全选  已选择<b class="font-red-mint">0</b>张</span>
	                        	<button class="btn btn-default share" type="button" >分享</button>
	                        	<button class="btn btn-default" type="button" data-toggle="modal" href="#small" onclick="getid(2)">选择分享人</button>
	                                	...
	                                	<div class="col-md-3 col-sm-3 album_list">
	                                		...
	                                		<div class="actions">
	                                			...
	                                			<ul>
	                                				...
	                                				<li data-toggle="modal" href="#small" onclick="getid(5)">删除</li>
	                                				<li data-toggle="modal" href="#small" onclick="getid(2)">分享</li>
	                                				<li data-toggle="modal" href="#small" onclick="getid(4)">设定封面</li>
	                                			</ul>
	                                		</div>
                                    	</div>
	                                	<div class="col-md-3 col-sm-3 album_list">
          ...
          <div class="page page2">
	          <div class="modal-dialog modal-md">
	              <div class="modal-content">
	                  <div class="modal-header">
	                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
	                      <h4 class="modal-title">分享照片</h4>
	                  </div>
	                 <div class="modal-body form-horizontal m_img_share" style="display:block">
	                	<h5><i></i>全选/取消全选<small>已选<b class="share_num">0</b>人</small></h5>
	                	<div class="row">
	                		<div class="col-md-2 col-sm-2"><p>哈哈</p></div>
	                		<div class="col-md-2 col-sm-2"><p>哈哈</p></div>
	                		<div class="col-md-2 col-sm-2"><p>哈哈</p></div>
	              ...
	              <div class="modal-content">
	                  ...
	                  <div class="modal-body">
	                  		<div class="alert alert-danger m_margin_10_auto m_text_align_conter">
                                <ul class="fa-ul">
                                    <li><i class="fa fa-warning fa-lg fa-li"></i>是否删除该照片</li>
                                </ul>
                            </div>
	                  </div>
	                  <div class="modal-footer">
	  ...
	  $(function(){
		  ...
		  $(".album_list").hover(function(){
		   ...
		   $(".share").on("click",function(){
				if($(this).text()=="分享"){
					$(this).text("取消分享");
					$(".select_num_photo").css({"display":"inline-block"});
					$(".actions").remove();
					$(".album_list em").css({"display":"block"});
				}else{
					$(this).text("分享");
					$(".select_num_photo").removeAttr("style");
					$(".album_list em").removeClass("fa fa-check");
					$(".album_list em").css({"display":"none"});
				}
		   })
		   //回复框
		   $(".reply").on("click",function(){
			   	$(".bbs_info").find("textarea").remove();
		   ...
		   //分享选人
			...
			//全选/取消全选
			$(".select_num_photo i").on("click",function(){
				if($(this).hasClass("fa fa-check")){
					$(this).removeClass("fa fa-check");
					$(".album_list em").removeClass("fa fa-check");
					$(".font-red-mint").text($(".album_list").find(".fa-check").length);
				}else{
					$(this).addClass("fa fa-check");
					$(".album_list em").addClass("fa fa-check");
					$(".font-red-mint").text($(".album_list").find(".fa-check").length);
				}
			})
			//单选
			$(".album_list em").on("click",function(){
				if($(this).hasClass("fa fa-check")){
					$(this).removeClass("fa fa-check");
					$(".font-red-mint").text($(".album_list").find(".fa-check").length);
				}else{
